        ...
        <div className="mb-6">
          ...
          {expandedSteps[1] && (
            <div className="ml-9 mt-3 space-y-4">
              ...
              {/* Subsection: Preparing Your Data */}
              <div className="border-l-2 border-blue-300 pl-4">
                <button
                  onClick={() => toggleSubsection('1-preparing')}
                  className="w-full text-left flex items-start gap-2 hover:text-blue-700 transition-colors py-2"
                >
                  <div className="flex-shrink-0 mt-0.5">
                    {expandedSubsections['1-preparing'] ? <ChevronDown size={16} /> : <ChevronRight size={16} />}
                  </div>
                  <h4 className="text-lg font-bold text-blue-900">Preparing Your Data</h4>
                </button>
                {expandedSubsections['1-preparing'] && (
                  <div className="ml-6 mt-2 space-y-4">
                    ...
                    <ul className="list-disc list-inside space-y-2 text-blue-900 ml-4">
                      <li>
                        ...
                        with the image paths. See <button
                          onClick={() => setActiveTab('getting-started')}
                          className="text-blue-600 hover:text-blue-700 underline font-medium hover:no-underline transition-colors"
                        >Step 4 in System Setup</button> for detailed instructions on hosting images with ImgBB.
                      </li>
                      <li>

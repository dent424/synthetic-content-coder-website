  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-8">
        ...
        {/* Step 0 */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-blue-900 mb-3">0. System Setup</h3>
        ...
        {/* Step 1 */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-blue-900 mb-3">1. Define Construct and Collect Content</h3>
          <p className="text-blue-900 mb-4">
            Clearly define what needs to be measured and collect the data to be coded.
          </p>

          <h4 className="text-lg font-bold text-blue-900 mb-2">Making Sure that SCCs are the Right Tool</h4>
          <p className="text-blue-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-blue-900 mb-2">Collecting Content</h4>
          <p className="text-blue-900 mb-4">
        ...
        {/* Step 2 */}
        <div className="mb-6">
          <h3 className="text-xl font-bold text-blue-900 mb-3">2. Partition the Data</h3>
          <p className="text-blue-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-blue-900 mb-2">Deciding Between Finetuned and Unfinetuned SCCs</h4>
          <p className="text-blue-900 mb-4">
          ...
          <p className="text-blue-900 mb-4">Finetuned SCCs may be particularly useful if:</p>
          <ul className="list-disc list-inside text-blue-900 space-y-2 ml-4 mb-4">
            <li>
          ...
          <h4 className="text-lg font-bold text-blue-900 mb-2">Principles for Partitioning Data</h4>
          <p className="text-blue-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-blue-900 mb-2">Partitioning Data for Unfinetuned SCCs</h4>
          <p className="text-blue-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-blue-900 mb-2">Partitioning Data for Finetuned SCCs</h4>
          <p className="text-blue-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-blue-900 mb-2">Why A Separate Validation Set Matters</h4>
      ...
      <div className="bg-emerald-50 border border-emerald-200 rounded-lg p-8">
        ...
        <div className="mb-8">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Defining the Criterion</h4>
          <p className="text-emerald-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Collecting and Checking Ratings</h4>
          <p className="text-emerald-900 mb-4">
        ...
        {/* Step 4 */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-emerald-900 mb-3">4. Set up your SCC</h3>
          <p className="text-emerald-900 mb-4">
          ...
          <p className="text-emerald-900 mb-4 italic">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Why Use an API</h4>
          <p className="text-emerald-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Documenting Model and Settings</h4>
          <p className="text-emerald-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Generating Prompts</h4>
          <p className="text-emerald-900 mb-4">
        ...
        {/* Step 5 */}
        <div className="mb-6">
          <h3 className="text-xl font-bold text-emerald-900 mb-3">5. Implement Response Handling</h3>
          <p className="text-emerald-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Temperature and Sampling Strategy</h4>
          <p className="text-emerald-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Aggregation, Batching, and Error Handling</h4>
          <p className="text-emerald-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-emerald-900 mb-2">Estimating Validation Performance</h4>
      ...
      <div className="bg-purple-50 border border-purple-200 rounded-lg p-8">
        ...
        {/* Step 6 */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-purple-900 mb-3">6. Collect SCC Ratings & Preregister</h3>
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">Freezing the SCC Specification</h4>
          <p className="text-purple-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">What to Preregister</h4>
          <p className="text-purple-900 mb-3">Preregistration should include:</p>
          <ul className="list-disc list-inside text-purple-900 space-y-2 ml-4 mb-4">
        ...
        {/* Step 7 */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-purple-900 mb-3">7. Collect Human Criterion Data</h3>
          <p className="text-purple-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">Matching the Development Protocol</h4>
          <p className="text-purple-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">Variants When Data Are Limited</h4>
          <p className="text-purple-900 mb-4">
        ...
        {/* Step 8 */}
        <div className="mb-8">
          <h3 className="text-xl font-bold text-purple-900 mb-3">8. Compare SCC & Human Ratings</h3>
          <p className="text-purple-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">Key Metrics</h4>
          <p className="text-purple-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">Checking Bias and Within-Context Generalizability</h4>
          <p className="text-purple-900 mb-4">
        ...
        {/* Step 9 */}
        <div className="mb-6">
          <h3 className="text-xl font-bold text-purple-900 mb-3">9. Deploy or Start Over</h3>

          <h4 className="text-lg font-bold text-purple-900 mb-2">Overview</h4>
          <p className="text-purple-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">Deploying on the Coding Set</h4>
          <p className="text-purple-900 mb-4">
          ...
          <h4 className="text-lg font-bold text-purple-900 mb-2">When to Restart</h4>
          <p className="text-purple-900 mb-4">
